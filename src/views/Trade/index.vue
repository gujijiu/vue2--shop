<template>
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address,index) in addressInfo" :ke="address.id" @click="changeDefault(address)">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="(order,index) in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" width="82px" height="80px" alt="">
          </li>
          <li>
            <p>
              {{order.skuName}}</p>
    ...
    <div class="sub clearFix">
      <button class="subBtn" @click="submitInfo">提交订单</button>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$store.dispatch('trade/getUserAddres');
    ...
    methods: {
      ...
      async submitInfo() {
        ...
        try {
          ...
          // let result = this.$http.submitOrder(tradeNo, data);
